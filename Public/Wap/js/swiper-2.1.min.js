var Swiper = function(f, b) {
    ...
    function U() {
        for (var b = a.pagingButtons, d = 0; d < b.length; d++) a.h.removeEventListener(b[d], "click", V, !1);
    }
    function V(b) {
        var d;
        b = b.target || b.srcElement;
        for (var e = a.pagingButtons, f = 0; f < e.length; f++) b === e[f] && (d = f);
        a.swipeTo(d);
    }
    ...
    if ((document.querySelectorAll || window.jQuery) && "undefined" !== typeof f && (f.nodeType || 0 !== g(f).length)) {
        ...
        var J, p, y, E, x, l, s = {
            ...
            slideElement:"div",
            slideClass:"banner_slide",
            slideActiveClass:"banner_slide_active",
            slideVisibleClass:"banner_slide_visible",
            wrapperClass:"banner_cx",
            pagingElementClass:"swiper-paging-switch",
            pagingActiveClass:"swiper-active-switch",
            pagingVisibleClass:"swiper-visible-switch"
        };
        b = b || {};
        ...
        a.calcSlides = function(c) {
            ...
            d && (d !== a.slides.length || c) && (v(), t(), a.updateActiveSlide(), b.createpaging && a.params.paging && a.createpaging(), 
        ...
        a.updateActiveSlide = function(c) {
            if (a.initialized && 0 != a.slides.length) {
                ...
                if (a.slides[a.activeIndex]) {
                    ...
                    b.paging && a.updatepaging(c);
                }
            }
        };
        a.createpaging = function(c) {
            b.pagingClickable && a.pagingButtons && U();
            var d = "", e = a.slides.length;
            b.loop && (e -= 2 * a.loopedSlides);
            for (var f = 0; f < e; f++) d += "<" + b.pagingElement + ' class="' + b.pagingElementClass + '"></' + b.pagingElement + ">";
            a.pagingContainer = b.paging.nodeType ? b.paging :g(b.paging)[0];
            a.pagingContainer.innerHTML = d;
            a.pagingButtons = [];
            document.querySelectorAll ? a.pagingButtons = a.pagingContainer.querySelectorAll("." + b.pagingElementClass) :window.jQuery && (a.pagingButtons = g(a.pagingContainer).find("." + b.pagingElementClass));
            c || a.updatepaging();
            a.callPlugins("onCreatepaging");
            if (b.pagingClickable) for (c = a.pagingButtons, d = 0; d < c.length; d++) a.h.addEventListener(c[d], "click", V, !1);
        };
        a.updatepaging = function(c) {
            if (b.paging && !(1 > a.slides.length)) {
                if (document.querySelectorAll) var d = a.pagingContainer.querySelectorAll("." + b.pagingActiveClass); else window.jQuery && (d = g(a.pagingContainer).find("." + b.pagingActiveClass));
                if (d && (d = a.pagingButtons, 0 != d.length)) {
                    for (var e = 0; e < d.length; e++) d[e].className = b.pagingElementClass;
                    ...
                    if (b.pagingAsRange) {
                        ...
                        for (e = 0; e < c.length; e++) d[c[e]] && (d[c[e]].className += " " + b.pagingVisibleClass);
                        b.loop ? d[a.activeLoopIndex].className += " " + b.pagingActiveClass :d[a.activeIndex].className += " " + b.pagingActiveClass;
                    } else b.loop ? d[a.activeLoopIndex].className += " " + b.pagingActiveClass + " " + b.pagingVisibleClass :d[a.activeIndex].className += " " + b.pagingActiveClass + " " + b.pagingVisibleClass;
                }
            }
        };
        ...
        a.init();
        n();
        b.paging && b.createpaging && a.createpaging(!0);
