...
class Spreadsheet_Excel_Reader {
	...
	function __construct($file='',$store_extended_info=true,$outputEncoding='') {
        vendor('ExcelReader.class#OLERead');
		$this->_ole = new \Vendor\ExcelReader\OLERead();
		...
		while($cont) {
			...
			switch ($code) {
                ...
                case SPREADSHEET_EXCEL_READER_TYPE_STRING:
					...
					$this->addcell($this->previousRow, $this->previousCol, $retstr);
					break;
