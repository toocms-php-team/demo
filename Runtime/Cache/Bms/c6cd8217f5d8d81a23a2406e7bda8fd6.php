...
<div class="alert alert-error" style="display: none">
  ...
  <button class="btn btn-success href" url="<?php echo U('Area/update');?>" target-form="ids">修改</button>&nbsp;
  <h2>布局预览</h2>
     <?php if($row["cate_id"] == 1 ): ?><div class="buju1" style="width: 500px;height: 500px;border: solid red 1px;">
	<div style="width: 200px;height: 200px;border: solid #000 1px;float: left;margin: 20px 20px"><a href="<?php echo ($row["url1"]); ?>"><img src="<?php echo ($img['1']['path']); ?>" style="width: 200px;height: 200px;"></a></div>
	<div style="width: 200px;height: 400px;border: solid #000 1px;float: right;margin: 50px 20px"><a href="<?php echo ($row["url3"]); ?>"><img src="<?php echo ($img['2']['path']); ?>" style="width: 200px;height: 400px;"></a></div>
	<div style="width: 200px;height: 200px;border: solid #000 1px;float: left;margin: 20px 20px"><a href="<?php echo ($row["url2"]); ?>"><img src="<?php echo ($img['3']['path']); ?>" style="width: 200px;height: 200px;"></a></div>
	
</div>
    <?php elseif($row["cate_id"] == 2 ): ?>
    <div class="buju2" style="width: 500px;height: 500px;border: solid red 1px;">
	<div style="width: 200px;height: 200px;border: solid #000 1px;float: right;margin: 20px 20px"><a href="<?php echo ($row["url1"]); ?>"><img src="<?php echo ($img['1']['path']); ?>" style="width: 200px;height: 200px;"></a></div>
	<div style="width: 200px;height: 400px;border: solid #000 1px;float: left;margin: 50px 20px"><a href="<?php echo ($row["url2"]); ?>"><img src="<?php echo ($img['2']['path']); ?>" style="width: 200px;height: 400px;"></a></div>
	<div style="width: 200px;height: 200px;border: solid #000 1px;float: right;margin: 20px 20px"><a href="<?php echo ($row["url3"]); ?>"><img src="<?php echo ($img['3']['path']); ?>" style="width: 200px;height: 200px;"></a></div>
	
</div>
    <?php else: ?> 
    <div class="buju3" style="width: 500px;height: 500px;border: solid red 1px;">
	<div style="width: 400px;height:400px;border: solid #000 1px;float: right;margin: 50px 50px"><a href="<?php echo ($row["url1"]); ?>"><img src="<?php echo ($img['1']['path']); ?>" style="width: 400px;height: 400px;"></a></div>
