                    ...
                    <div class="invoice-content">
                        <div class="invoice-head invoice-left">
                            <div class="invoice-meta">
                                模板标识<span class="invoice-number"></span>
                            </div>
                            <h5><?php echo ((isset($row['unique_code']) && ($row['unique_code'] !== ""))?($row['unique_code']):'未使用模板'); ?></h5>
                            <div class="invoice-meta">
                                模板描述<span class="invoice-number"></span>
                            </div>
                            <h5><?php echo ((isset($row['description']) && ($row['description'] !== ""))?($row['description']):'未使用模板'); ?></h5>
                            <div class="invoice-meta">
                                发信类型<span class="invoice-number"></span>
                            </div>
                            <h5><?php echo (get_config_title($row['type'],SEND_TEMPLATE_TYPES)); ?></h5>
                            <div class="invoice-meta">
                                接收账号<span class="invoice-number"></span>
                            </div>
                            <h5><?php echo ($row['receiver']); ?></h5>
                            <div class="invoice-meta">
                                发送标题<span class="invoice-number"></span>
                            </div>
                            <h5><?php echo ((isset($row['subject']) && ($row['subject'] !== ""))?($row['subject']):'---'); ?></h5>
                            <div class="invoice-meta">
                                发送内容<span class="invoice-number"></span>
                            </div>
                            <h5><?php echo ($row['content']); ?></h5>
                            <div class="invoice-meta">
                                发送时间<span class="invoice-number"></span>
                            </div>
                            <h5><?php echo (date('Y-m-d H:i',$row['create_time'])); ?></h5>
                            <div class="invoice-meta">
                                发送状态<span class="invoice-number"></span>
                            </div>
                            <h5><?php echo (get_send_status($row['status'])); ?></h5>
                            <div class="invoice-meta">
                                发送者<span class="invoice-number"></span>
                            </div>
                            <h5><?php echo ((isset($row['account']) && ($row['account'] !== ""))?($row['account']):'系统'); ?></h5>
                            <br>
