...
<div class="alert alert-error" style="display: none">
                ...
                <div class="widget-content tab-content no-padding">
                    ...
                    <form class="form-horizontal text-height-27-form" method="post" action="<?php echo U('Article/update');?>" id="form">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="title" value="<?php echo ($row['title']); ?>" class="text-width-50" maxlength="45">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="short_desc" value="<?php echo ($row['short_desc']); ?>" class="text-width-30" maxlength="15">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo hook('upload',array('is_first'=>1,'unique_sign'=>'article_cover','field_name'=>'cover','field_value'=>$row['cover'],'save_path'=>'Article'));?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo hook('upload',array('queue_limit'=>'5','unique_sign'=>'article_pic','field_name'=>'pictures','field_value'=>$row['pictures'],'save_path'=>'Article'));?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <?php echo hook('adminArticleEdit', array('is_first'=>1,'name'=>'content','value'=>$row['content'],'width'=>810));?>
    ...
    <div class="modal-footer">
        <a class="btn btn-success" href="javascript:void(0)" onclick="saveRG()">确定</a>
...
<script>
    var id = 0;
    function setSrc(obj) {
        id = $(obj).attr('data-id'), type = $(obj).attr('data-type');
        if(type == 1)
            $('#dispatch-Iframe').attr('src', '<?php echo C("NOW_HOST");?>Goods/modal/art_id/'+id);
    }

    function saveRG() {
        window.location.href = '<?php echo C("NOW_HOST");?>Article/saveRG/art_id/'+id;
    }
</script>
