        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content no-padding">
                    <form class="form-horizontal text-height-27-form" method="post" action="<?php echo U('ArticleCategory/update');?>">
                        <input type="hidden" name="model" value="ArticleCategory">
                        <input type="hidden" name="id" value="<?php echo ($row['id']); ?>">
                        <div class="control-group">
                            <label class="control-label">分类名称</label>
                            <div class="controls">
                                <input type="text" name="name" value="<?php echo ($row['name']); ?>" class="text-width-20">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo ($select); ?>
                                <span class="help-block">父级分类</span>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">关键字</label>
                            <div class="controls">
                                <input type="text" name="keywords" value="<?php echo ($row['keywords']); ?>" class="text-width-40">
                                <span class="help-block">英文逗号隔开</span>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="link" value="<?php echo ($row['link']); ?>" class="text-width-40">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="description" value="<?php echo ($row['description']); ?>" class="text-width-70">
                                <span class="help-block">描述该分类</span>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">图标</label>
                            <div class="controls">
                                <?php echo hook('upload',array('is_first'=>1,'unique_sign'=>'article_category_icon','field_name'=>'icon','field_value'=>$row['icon'],'save_path'=>'ArticleCategoryIcon'));?>
                                <span class="help-block">分类小图标大小比例 1:1</span>
                            </div>
                        </div>
                        <!--<div class="control-group">
                            <label class="control-label">图标</label>
                            <div class="controls">
                                hook('upload',array('unique_sign'=>'article_category_atta','field_name'=>'atta','field_value'=>$row['atta'],'save_path'=>'ImportTemplate','type'=>'attachment'))
                                <span class="help-block">分类小图标大小比例 1:1</span>
                            </div>
                        </div>-->
