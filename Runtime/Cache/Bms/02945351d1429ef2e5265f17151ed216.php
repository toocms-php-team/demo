        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-title widget-title-search list-widget-title">
                    <button class="btn btn-success href" url="<?php echo U('GoodsHotSearch/add');?>" target-form="ids">新增</button>&nbsp;
                    <button class="btn btn-danger confirm ajax-post" url="<?php echo U('GoodsHotSearch/delete',array('model'=>'GoodsHotSearch'));?>" target-form="ids">删除</button>&nbsp;
                </div>
                ...
                <div class="widget-content no-padding no-border">
                    <table class="table table-bordered table-striped with-check reset-checkbox">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <select class="quick-edit-select" data-model="GoodsHotSearch" data-id="<?php echo ($row['id']); ?>" data-field="is_hot" data-focus-value="<?php echo ($row['is_hot']); ?>" onchange="quick_edit_select_change(this)">
                                        <option value="1" >是</option>
                                        <option value="0" >否</option>
                                    </select>
                                </td>
                                <td>
                                    <a href="<?php echo U('GoodsHotSearch/update',array('id'=>$row['id'],'model'=>'GoodsHotSearch'));?>" title="编辑" class="">
                                        <span class="label label-success label-success-hover">编辑</span></a>&nbsp;
                                    <a href="<?php echo U('GoodsHotSearch/delete',array('model'=>'GoodsHotSearch','ids'=>$row['id']));?>" title="删除" class="confirm ajax-get">
