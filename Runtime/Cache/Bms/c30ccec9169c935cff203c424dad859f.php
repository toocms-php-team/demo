                    ...
                    <ul class="quick-actions-horizontal">
                        <li>
                            <a href="javascript:void(0)">
                                <i class="icon-tag"></i>
                                <span>用户成功支付总额：￥<?php echo ((isset($result['total_2']) && ($result['total_2'] !== ""))?($result['total_2']):0); ?></span>
                                <!--<span>用户未支付总额：￥<?php echo ((isset($result['total_1']) && ($result['total_1'] !== ""))?($result['total_1']):0); ?></span>-->
                                <span>用户成功退款总额：￥<?php echo ((isset($result['total_3']) && ($result['total_3'] !== ""))?($result['total_3']):0); ?></span>
                            </a>
                        </li>
                    </ul>
                    <form action="<?php echo U('CashTurnover/index');?>" method="post" class="form">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li data-value="1" data-title="支付宝" <?php if(($_REQUEST['payment']) == "1"): ?>class="selected"<?php endif; ?>><a href="javascript:void(0)">支付宝</a></li>
                                <li data-value="2" data-title="微信" <?php if(($_REQUEST['payment']) == "2"): ?>class="selected"<?php endif; ?>><a href="javascript:void(0)">微信</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <!--<li data-value="0" data-title="--取消选择--"><a href="javascript:void(0)">--取消选择--</a></li>-->
                                <li data-value="1" data-title="购买" <?php if(($_REQUEST['trend']) == "1"): ?>class="selected"<?php endif; ?>><a href="javascript:void(0)">购买</a></li>
                                <!--<li data-value="2" data-title="充值" <?php if(($_REQUEST['trend']) == "2"): ?>class="selected"<?php endif; ?>><a href="javascript:void(0)">充值</a></li>-->
                                <li data-value="3" data-title="退款" <?php if(($_REQUEST['trend']) == "3"): ?>class="selected"<?php endif; ?>><a href="javascript:void(0)">退款</a></li>
                            </ul>
                        </div>
                ...
                <div class="widget-content no-padding no-border">
                    <table class="table table-bordered table-striped reset-checkbox">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>￥ <?php echo ($row['amounts']); ?> 元</td>
                                <td><?php echo ((isset($row['turnover_number']) && ($row['turnover_number'] !== ""))?($row['turnover_number']):'---'); ?></td>
                                <td><a href="<?php echo U('OrderInfo/update', array('id'=>$row['order_id']));?>"><?php echo ((isset($row['order_sn']) && ($row['order_sn'] !== ""))?($row['order_sn']):'---'); ?></a></td>
                                <td><?php echo (timestamp2date($row['create_time'])); ?></td>
                                <td>
                                    <?php if($row['status'] == 1): ?><span class="green-1">成功</span>
                                        <?php else: ?>
                                        <span class="">未支付</span><?php endif; ?>
                                </td>
                        ...
                        <tr>
                            ...
                            <td colspan="10">
                                <span class="yellow-1">
                                当前条件用户成功支付总额：￥<?php echo ((isset($result['now_total_2']) && ($result['now_total_2'] !== ""))?($result['now_total_2']):0); ?><br>
                                <!--当前条件用户未支付总额：￥<?php echo ((isset($result['now_total_1']) && ($result['now_total_1'] !== ""))?($result['now_total_1']):0); ?></span>-->
                                当前条件用户成功退款总额：￥<?php echo ((isset($result['now_total_3']) && ($result['now_total_3'] !== ""))?($result['now_total_3']):0); ?></span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
