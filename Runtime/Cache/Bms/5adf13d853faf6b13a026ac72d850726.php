            ...
            <div class="widget-box">
                ...
                <div class="widget-content">
                    <div class="row-fluid">
                        <div class="span4">
                            <ul class="site-stats">
                                <li><i class="fa fa-user"></i> <strong><?php echo ($total_1); ?></strong> <small>用户总数</small></li>
                                <li><i class="fa fa-user-md"></i> <strong><?php echo ($total_2); ?></strong> <small>预约总数</small></li>
                                <!--<li class="divider"></li>-->
                                <li><i class="fa fa-cart-plus"></i> <strong><?php echo ($total_3); ?></strong> <small>商品总数</small></li>
                                <li><i class="fa fa-tasks"></i> <strong><?php echo ($total_4); ?></strong> <small>订单总数</small></li>
								<li><i class="fa fa-bookmark"></i> <strong><?php echo ($total_5); ?></strong> <small>帖子总数</small></li>
								<li><i class="fa fa-book"></i> <strong><?php echo ($total_6); ?></strong> <small>文章总数</small></li>
                            </ul>
                        </div>
                        <div class="span8">
