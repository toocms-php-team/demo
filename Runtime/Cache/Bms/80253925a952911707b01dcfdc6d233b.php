...
<div class="alert alert-error" style="display: none">
    ...
    <br>
    <table>
     <form method="post" action="<?php echo U('Area/add');?>">
  <tr>
	<th>ID</th>
    <th>标题</th>
    <th>分类</th>
  ...
  <td>1  </td>
	<td>布局</td>
	<td><select name="buju" id="buju" onchange="changebuju()">
  ...
  <tr>
	...
	<td>预览</td>
	<td>
	<img src="/Public/Bms/img/buju1.png" id="img1" style="display: none;height: 200px;width: 200px">
	<img src="/Public/Bms/img/buju2.png" id="img2"  style="display: none;height: 200px;width: 200px">
	<img src="/Public/Bms/img/buju3.png" id="img3" style="display: none;height: 200px;width: 200px"></td>
  </tr>
  <tr  id="child1">
	<td>3</td>
	<td>子模块1</td>
	<td>上传图片
	<div class="controls">
                                <?php echo hook('upload',array('is_first'=>1,'unique_sign'=>'area_pic1','field_name'=>'cover1','field_value'=>$row['cover'],'save_path'=>'Article'));?>
                               
                            </div>
	</td>
	<td><input type="text" name="url1" placeholder="输入url" value="<?php echo ($row["url1"]); ?>"></td>
  </tr>
  <tr id="child2">
	<td>4</td>
	<td>子模块2</td>
	<td>上传图片
	<div class="controls">
                              <?php echo hook('upload',array('unique_sign'=>'area_pic2','field_name'=>'cover2','field_value'=>$row['cover'],'save_path'=>'Article'));?>
                               
                            </div>
	</td>
	<td><input type="text" name="url2" placeholder="输入url" value="<?php echo ($row["url2"]); ?>"></td>
  </tr>
  <tr id="child3">
	<td >5</td>
	<td>子模块3</td>
	<td>上传图片 
	<div class="controls"> 
                                <?php echo hook('upload',array('unique_sign'=>'area_pic3','field_name'=>'cover3','field_value'=>$row['cover'],'save_path'=>'Article'));?>
                               
                            </div>
    </td>
	<td><input type="text" name="url3" placeholder="输入url" value="<?php echo ($row["url3"]); ?>"></td>
  </tr>
  
 
  <tr>
	<td> <button class="btn btn-info " type="submit" id="submit" target-form="form-horizontal">保 存</button></td>
	<td></td>
	<td></td>
  </tr>
...
//                    }
	...
	$(function(){
		var cate=<?php echo ($row["cate_id"]); ?>;
		
		
		$('#buju').val(cate).attr("selected", true);
  		$('#img<?php echo ($row["cate_id"]); ?>').show();
