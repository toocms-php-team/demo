...
<html>
    ...
    <div class="center sliding">消息详情</div>
    <div class="right"></div>
    ...
    <div class="page-content">
        <div class="dope">
            <div class="xq">
                <span><em class="fl">【<?php echo ($msg['subject']); ?>】</em><em class="fr"><?php echo ($msg['create_time']); ?></em></em></span>
                <!--<b><img src="/Public/Wap/img/index_04.png"></b>-->
